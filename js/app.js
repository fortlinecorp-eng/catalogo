...
function abrirModalAcabamento(acabamento, categoria) {
    ...
    detalhes.innerHTML = `
        ...
        <div class="cabecalho-acabamento">

            <img
                src="imagens/${acabamento.imagem}"
                onerror="this.src='imagens/sem_imagem.jpg'"
                class="imagem-modal-acabamento"
            >
            ...
            ${
                acabamento.badge
                ? `<span class="badge-acabamento-modal">${acabamento.badge}</span>`
                : ""
            }
        ...
        ${
            acabamento.aplicacao
            ? `
                <div class="bloco-modal">

                    <h3>Aplicação</h3>

                    <p>${acabamento.aplicacao}</p>
        ...
        ${
            acabamento.observacao
            ? `
                <div class="bloco-modal">

                    <h3>Observações</h3>

                    <p>${acabamento.observacao}</p>
        ...
        ${
            acabamento.linhas?.length
            ? `
                <div class="bloco-modal">

                    <h3>Disponível nas linhas</h3>

                    <div class="chips-linhas">

                        ${acabamento.linhas.map(linha => `
                            <span class="chip-linha">${linha}</span>
                        `).join("")}
